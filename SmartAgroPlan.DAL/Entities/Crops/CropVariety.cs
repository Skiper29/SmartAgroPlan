...
public class CropVariety
{
    ...
    [MaxLength(500)]
    public string? AdditionalNotes { get; set; }        // Additional notes or comments
    ...
    public ICollection<FieldCropHistory>? FieldCropHistories { get; set; } = new List<FieldCropHistory>(); // Navigation property to FieldCropHistories
}