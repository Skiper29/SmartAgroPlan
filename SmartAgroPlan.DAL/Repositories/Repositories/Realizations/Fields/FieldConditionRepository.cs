...
public class FieldConditionRepository : RepositoryBase<FieldCondition>, IFieldConditionRepository
{
    public FieldConditionRepository(SmartAgroPlanDbContext dbContext) : base(dbContext)
    {
    }
}
